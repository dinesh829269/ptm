...
void Shutdown()
{
    ...
    RenameThread("bitphantom-shutoff");
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-conf=<file>", strprintf("Specify configuration file. Relative paths will be prefixed by datadir location. (default: %s)", bitphantom_CONF_FILENAME), false, OptionsCategory::OPTIONS);
...
#ifndef WIN32
    gArgs.AddArg("-pid=<file>", strprintf("Specify pid file. Relative paths will be prefixed by a net-specific datadir location. (default: %s)", bitphantom_PID_FILENAME), false, OptionsCategory::OPTIONS);
#else
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitphantomcurrency/bitphantom>";
    const std::string URL_WEBSITE = "<https://bitphantomcurrency.com>";

    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2009, COPYRIGHT_YEAR) + " ") + "\n" +
           strprintf(_("Copyright (C) %i-%i The bitphantom Core developers"), 2018, COPYRIGHT_YEAR) + "\n" +
           "\n" +
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("bitphantom-loadblk");
...
bool AppInitMain()
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", bitphantom_CONF_FILENAME)).string());
