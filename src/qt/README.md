...
Used to process BIP21 and BIP70 (see https://github.com/bitcoin/bitcoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a bitphantom:... link from a browser).
...
* `bitphantomunits.(h/cpp)`: XVG / mXVG / etc handling
* `callback.h`
