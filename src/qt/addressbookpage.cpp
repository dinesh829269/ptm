    ...
    tab(_tab)
{
    ...
    case SendingTab:
        ...
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your bitphantom addresses for receiving payments. It is recommended to use a new receiving address for each transaction."));
