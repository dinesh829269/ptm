...
Contains files used to package bitphantomd/bitphantom-qt
...
Files used during the gitian build process. For more information about gitian, see the [the bitphantom Core documentation repository](/doc).
...
### [RPM](/contrib/rpm) ###
RPM spec file for building bitphantom-core on RPM based distributions.
