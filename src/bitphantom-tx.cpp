...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf("%s bitphantom-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  bitphantom-tx [options] <hex-tx> [commands]  Update hex-encoded bitphantom transaction\n" +
              "  bitphantom-tx [options] -create [commands]   Create hex-encoded bitphantom transaction\n" +
              "\n";
